...
\begin{frame}[fragile]
  ...
  Alternatively, one can put a list of citations in the footer via \verb|\footfullcite|\footfullcite{BNPS2019}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Use \verb|\refer{...}| to refer a paper quickly (without the need for a bibfile entry): \refer{Hoos et al.}
